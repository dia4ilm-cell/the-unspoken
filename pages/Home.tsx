    ...
    <div className="fade-in">
      ...
      <section className="relative h-screen w-full flex items-center justify-center bg-white px-6">
        <div className="relative z-10 text-center text-black">
          <h1 className="text-7xl md:text-[11rem] font-serif mb-8 tracking-tighter leading-none">
            The <br />
            <span className="italic font-normal">Unspoken</span>
          </h1>
          <p className="text-[10px] md:text-xs tracking-[0.8em] font-light uppercase opacity-40 max-w-2xl mx-auto mb-20">
            Cinematic storytelling for the refined couple.
          </p>
