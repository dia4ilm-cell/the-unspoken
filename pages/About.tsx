        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-32">
          ...
          <div className="order-1 lg:order-2 reveal">
            ...
            <div className="space-y-8 text-black/70 font-light leading-loose text-lg">
              ...
              <p>
                Shaped by encounters with different cultures and traditions, my work is guided by mood, nuance, and atmosphere — much like a finely crafted fragrance, where emotion is suggested rather than explained.
              </p>
              <p>
                I don’t simply document weddings — I curate experiences. I look for beauty in the quiet moments: the way a veil catches the wind, the tremor in a voice during vows.
              </p>
            </div>
        ...
        <div className="bg-white border-t border-b border-black/5 py-32 px-12 -mx-6 md:mx-0 reveal">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-20 text-center">
            <div className="reveal">
              <span className="text-5xl font-serif text-black mb-8 block font-bold opacity-10">01.</span>
              <h3 className="text-[10px] uppercase tracking-[0.4em] mb-6 font-bold">Discovery</h3>
              <p className="text-[10px] text-black/50 font-light leading-relaxed uppercase tracking-widest">
                We begin with a deep dive into your story, your aesthetic preferences, and the vision for your day.
              </p>
            </div>
            <div className="reveal">
              <span className="text-5xl font-serif text-black mb-8 block font-bold opacity-10">02.</span>
              <h3 className="text-[10px] uppercase tracking-[0.4em] mb-6 font-bold">Artistry</h3>
              <p className="text-[10px] text-black/50 font-light leading-relaxed uppercase tracking-widest">
                On the day, my team and I work discretely, observing and capturing with an editorial eye.
              </p>
            </div>
            <div className="reveal">
              <span className="text-5xl font-serif text-black mb-8 block font-bold opacity-10">03.</span>
              <h3 className="text-[10px] uppercase tracking-[0.4em] mb-6 font-bold">Alchemy</h3>
              <p className="text-[10px] text-black/50 font-light leading-relaxed uppercase tracking-widest">
